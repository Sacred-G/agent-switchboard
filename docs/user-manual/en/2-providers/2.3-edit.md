...
Agent Switchboard provides rich icon customization features:
...
This ensures Agent Switchboard and CLI tool configurations stay in sync.
...
When adding a provider, Agent Switchboard automatically extracts endpoint URLs from the configuration.
