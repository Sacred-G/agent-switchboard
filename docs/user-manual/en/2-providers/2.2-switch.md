...
2. Agent Switchboard updates the configuration file
...
1. Right-click the Agent Switchboard icon in the system tray
...
When switching providers, Agent Switchboard modifies the following files:
