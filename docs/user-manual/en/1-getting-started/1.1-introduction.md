...
## What is Agent Switchboard

Agent Switchboard is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
Agent Switchboard solves these problems through a unified interface.
...
Agent Switchboard is built with a modern technology stack:
