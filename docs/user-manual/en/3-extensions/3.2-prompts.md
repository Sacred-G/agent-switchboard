...
With Agent Switchboard, you can:
...
Agent Switchboard provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
agent-switchboard://import/prompt?data=<base64-encoded preset>
```
