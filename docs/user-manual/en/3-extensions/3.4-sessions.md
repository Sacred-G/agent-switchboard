...
**On macOS:**
- Agent Switchboard launches your preferred terminal with the resume command
...
3. Agent Switchboard launches the Claude terminal session in the selected directory
