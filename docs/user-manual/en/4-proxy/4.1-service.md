...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (Agent Switchboard)
...
After starting the proxy and enabling app takeover, Agent Switchboard modifies app configurations:
...
When stopping the proxy, Agent Switchboard will:
