...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | agent-switchboard storage, CLI configuration file formats |
...
- Applicable to agent-switchboard v3.16.0+
