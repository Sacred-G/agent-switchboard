//! Deep link import functionality for Agent Switchboard
//!
//! This module implements the agent-switchboard:// protocol for importing configurations
...
///
/// Represents a parsed agent-switchboard:// URL ready for processing.
