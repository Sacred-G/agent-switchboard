...
//!
//! This module is used when the Codex client talks to Agent Switchboard through the
...
pub(crate) fn response_id_from_chat_id(id: Option<&str>) -> String {
    let id = id.unwrap_or("agent-switchboard");
...
mod tests {
    ...
    // https://github.com/farion1231/agent-switchboard/issues/3557
