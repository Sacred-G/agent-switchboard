...
//!
//! Handles conversion between Agent Switchboard unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | Agent Switchboard unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// Agent Switchboard has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: Agent Switchboard -> Hermes
// ============================================================================

/// Convert Agent Switchboard unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> Agent Switchboard
// ============================================================================

/// Convert Hermes format to Agent Switchboard unified format
///
/// Conversion rules:
...
/// `existing` — this prevents Agent Switchboard from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive Agent Switchboard round-trip"
        );
    }
