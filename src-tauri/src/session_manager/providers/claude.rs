    ...
    fn parse_session_new_format_with_snapshot() {
        ...
        std::fs::write(
            ...
            concat!(
                ...
                "{\"type\":\"user\",\"message\":{\"role\":\"user\",\"content\":\"Please help me refactor this function\"},\"sessionId\":\"session-new\",\"timestamp\":\"2026-03-06T10:00:00Z\",\"cwd\":\"/tmp/project\"}\n",
    ...
    fn parse_session_skips_command_caveat_and_slash_commands() {
        ...
        std::fs::write(
            ...
            concat!(
                ...
                "{\"type\":\"user\",\"message\":{\"role\":\"user\",\"content\":\"Help me check changes in the workspace\"},\"sessionId\":\"session-clear\",\"timestamp\":\"2026-03-06T10:01:00Z\",\"cwd\":\"/tmp/project\"}\n",
            ),
        )
        .expect("write");
