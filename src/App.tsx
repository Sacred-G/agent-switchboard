...
const STORAGE_KEY = "agent-switchboard-last-app";
...
const VIEW_STORAGE_KEY = "agent-switchboard-last-view";
    ...
    (payload) => {
      toast.warning(
        t("notifications.proxyOfficialWarning", {
          ...
          defaultValue: `The current provider ${payload.providerName} is an official provider, we recommend switching to a third-party provider before using proxy takeover`,
        }),
        { duration: 8000 },
      );
    },
      ...
      try {
        ...
        toast.error(
          t("provider.duplicateLiveIdsLoadFailed", {
            defaultValue:
              "Failed to read provider identifier from config，please fix configuration first and try again",
            ...
            {currentView !== "providers" ? (
              ...
              <div className="flex items-center gap-2">
                <div className="relative inline-flex items-center">
                  <a
                    href="https://agent-switchboard.io"
                    target="_blank"
                    rel="noreferrer"
                    className={cn(
