        ...
        if (result.status === "operational") {
          toast.success(
            t("streamCheck.reachable", {
              ...
              defaultValue: `${providerName} Connected Normal (${result.responseTimeMs}ms)`,
            }),
            { closeButton: true },
          );
          ...
          toast.warning(
            t("streamCheck.reachableSlow", {
              providerName: providerName,
              responseTimeMs: result.responseTimeMs,
              defaultValue: `${providerName} Connected Slow (${result.responseTimeMs}ms)`,
            }),
          );
        } else {
          toast.error(
            t("streamCheck.unreachable", {
              ...
              defaultValue: `${providerName} Connection failed: ${result.message}`,
            }),
            {
